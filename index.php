...
<body>
  ...
  <main class="main">
    ...
    <form class="form" action="" method="post">
      ...
      <p>¿Ya tienes una cuenta? <a href="log_in.php">Inicie sesión aqui</a></p>
    </form>
  </main>
  <section id="nosotros">
    <div class="nosotros_info">
      <h2>Nosotros</h2>
      <div class="nosotros_contenedor">
        <div>
          <h3>Misión</h3>
          <p>Somos una comunidad educativa transformadora que brinda una educación de calidad en el distrito de Miraflores, ofreciendo a nuestros estudiantes una experiencia educativa humanista para convertirlos en agentes de cambio competentes, autónomos y creativos.</p> <br><br>
          <h3>Visión</h3>
          <p>Ser una institución educativa referente a nivel nacional e internacional reconocida por el alto compromiso de sus egresados en la búsqueda de  una justa y verdadera  transformación social y cultural.</p> 
        </div>
        <div><img src="assets/nosotros.jpg" alt=""></div>
      </div>
    </div>
  </section>
