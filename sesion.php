...
<body>
  <?php
    ...
    $clave_reg=$_SESSION['clave'];
    
    $datos="SELECT nombre,apellido,email FROM datos WHERE email='$email_reg' and clave='$clave_reg'";
    
    $result=mysqli_query($conect,$datos);
  ...
  <header class="header">
    <div>
      ...
      <div class="header_datos">
        <h2><?php echo $nom; ?><br><p><?php echo $email; ?></p></h2>
  ...
  <section id="galeria">
    <div class="galeria_main">
      ...
      <div class="galeria_container">
        <div>
          <img src="assets/galeria.jpg" alt="">
        </div>
        <div>
        ...
        <div>
          <img src="assets/galeria3.jpg" alt="">
        </div>
        <div>
          <img src="assets/galeria4.jpg" alt="">
        </div>
        <div>
          <img src="assets/galeria.jpg" alt="">
        </div>
